...
extension NIOSSHCertifiedPublicKey {
    ...
    internal var keyPrefix: String.UTF8View {
        ...
        case .custom:  // NIOSSH patch (sshconfigmanager): CustomKeys — not used as cert base keys.
            preconditionFailure("custom keys are not supported as certified base keys")
        case .certified:
