...
internal struct UserAuthSignablePayload {
    ...
    init(sessionIdentifier: ByteBuffer, userName: String, serviceName: String, publicKey: NIOSSHPublicKey) {
        ...
        // NIOSSH patch (sshconfigmanager): PR #3 — sign over the RFC 8332 userauth algorithm
        // name so it matches the SSH_MSG_USERAUTH_REQUEST (equals keyPrefix for bundled keys).
